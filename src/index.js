/**
 *  @package Solidity NatSpec Generator
 *  @description Generate the Solidity NatSpec Documentation files
...
const CONTRACT_OUTPUT_DIR = "./docs/pages/src";
...
console.log("Creating .natspec.yaml file...")
fs.writeFileSync (".natspec.yaml", "root: ./\n");
fs.appendFileSync(".natspec.yaml", "structure:\n");
fs.appendFileSync(".natspec.yaml", "  readme: " + README_FILE + "\n");
fs.appendFileSync(".natspec.yaml", "  summary: " + SUMMARY_FILE + "\n");

// @note Change `solc` to hardhat/node_modules/solc for using framework 
